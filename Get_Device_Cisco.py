...
Reuse from
Author: Nick Russo
Purpose: Demostrate Python "requests" to get the list of devices
from Cisco DNA Center using the REST API
"""

import requests
from  Collect_Token_Cisco import get_token
...
def main():
    ...
    # Reuse the get_token() function from before. 
    # If it fails allow exception to crash program
    token = get_token()
    ...
    #Iternate over list of dictionaries and print device ID and management IP
    if get_resp.ok:
